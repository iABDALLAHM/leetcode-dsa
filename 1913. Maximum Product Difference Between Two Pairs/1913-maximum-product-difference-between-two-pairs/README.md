...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/maximum-product-difference-between-two-pairs/)
...
**My Solution:** [1913-Maximum-Product-Difference-Between-Two-Pairs.cpp](./1913-Maximum-Product-Difference-Between-Two-Pairs.cpp)
