...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/check-if-number-has-equal-digit-count-and-digit-value/)
...
**My Solution:** [2283-Check-if-Number-Has-Equal-Digit-Count-and-Digit-Value.dart](./2283-Check-if-Number-Has-Equal-Digit-Count-and-Digit-Value.dart)
